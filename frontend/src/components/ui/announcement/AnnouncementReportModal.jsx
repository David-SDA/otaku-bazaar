            ...
            <div className='bg-white p-6 rounded-lg w-96 shadow-lg'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='flex justify-end'>
                        <button type='button' onClick={onClose} className='bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded-lg mr-2' disabled={isSubmitting}>
                            Cancel
                        </button>
                        <button type='submit' className='bg-red-500 text-white font-bold py-2 px-4 rounded-lg' disabled={isSubmitting}>
