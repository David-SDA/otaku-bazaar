    ...
    return (
        <div className='bg-[#F7EDE2] border border-[#F5CAC3] rounded-lg flex flex-col shrink-0 w-56 group'>
            <Link to={`/announcements/${announcement.id}`} className='p-5 rounded-lg' draggable='false'>
                <img src={sortedImages.length > 0 ? sortedImages[0]?.path : 'https://placehold.co/400'} alt='' className='object-cover rounded-lg shadow w-[182px] h-[182px] pointer-events-none group-hover:scale-105 transition-all duration-300' />
