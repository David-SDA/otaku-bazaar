...
export default function CategoryCard({category, categoryImage}){
    return (
        <Link to={'/'} className='rounded-lg h-32 relative shadow overflow-hidden group hover:scale-105 hover:border hover:border-[#F5CAC3] transition-all duration-300 ease-out select-none'>
