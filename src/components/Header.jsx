...
export default function Header() {
    ...
    return (
        <header className='h-24 py-2 border-b-2 border-[#F6BD60] text-neutral-800 font-bold flex items-center'>
            <nav className='container mx-auto flex justify-between items-center'>
                ...
                <div className={`lg:hidden absolute top-0 right-0 h-screen w-80 py-5 bg-[#F6BD60] flex flex-col transition-transform duration-300 ${isBurgerMenuOpen ? 'translate-x-0' : 'translate-x-80'}`}>
